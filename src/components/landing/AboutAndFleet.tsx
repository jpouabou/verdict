...
const features = [
  ...
  {
    title: "Honest assessment, no fluff",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <RevealOnScroll>
            <div>
              ...
              <h3 className="headline-section text-[var(--foreground)] mb-6">
                Decision engine with rigor. No magic.
              </h3>
              <p className="text-[var(--muted)] leading-relaxed mb-6">
                Verdict runs ideas through a multi-model reasoning approach and a
                structured rubric. We assess market demand, competition,
                monetization clarity, timing, and more.
              </p>
            ...
            <RevealOnScroll delay={200}>
              <div>
                ...
                <p className="text-sm text-[var(--muted)] mb-6">
                  Affordable service, honest verdicts, good experience.
                </p>
